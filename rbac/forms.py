...
class PermissionForm(forms.ModelForm):
    ...
    class Meta:
        model = Permission
        fields = ["title", "url", "name", "pid", "icon", "is_menu", "sort"]
        help_texts = {
            'pid': '父级权限',
        }
        widgets = {
            ...
            'icon': forms.TextInput(attrs={'class': "form-control", 'placeholder': '请输入图片路径'}),
            'is_menu': forms.CheckboxInput(),
            'sort': forms.TextInput(attrs={'class': "form-control", 'placeholder': '请输入顺序号'}),
        }
...
class UserForm(forms.ModelForm):
    password1 = forms.CharField(label="确认密码", max_length=32, widget=forms.TextInput(attrs={'class': 'form-control', 'placeholder': '请重新输入密码'}))
    ...
    class Meta:
        model = UserInfo
        fields = [
            "name", "real_name", "gender", "post", "password", "password1", "telephone", "email",  "job",
            "job_time", "license_num", "prof_title", "is_superuser", "is_active", "roles"
        ]
        widgets = {
            'name': forms.TextInput(attrs={'class': "form-control", 'placeholder': '请输入登录名'}),
            ...
            'password': forms.TextInput(attrs={'class': "form-control", 'placeholder': '请输入密码'}),
            ...
            'roles': forms.SelectMultiple(attrs={'class': "form-control", 'placeholder': '请选择角色'}),
        }
...
class UpdateUserForm(forms.ModelForm):
    ...
    class Meta:
        model = UserInfo
        fields = [
            "name", "real_name", "gender", "post", "password", "telephone", "email", "job",
            "job_time", "license_num", "prof_title", "is_superuser", "is_active"
        ]
        widgets = {
            'name': forms.TextInput(attrs={'class': "form-control", "readonly": "true", 'placeholder': '请输入登录名'}),
            'real_name': forms.TextInput(attrs={'class': "form-control", 'placeholder': '请输入姓名'}),
            'gender': forms.Select(attrs={'class': "form-control", 'placeholder': '请选择性别'}),
            'password': forms.TextInput(attrs={'class': "form-control", 'placeholder': '请输入密码'}),
            'telephone': forms.TextInput(attrs={'class': "form-control", 'placeholder': '请输入手机号码'}),
...
class PasswordChangeForm(forms.Form):
    ...
    def clean(self):
        ...
        new_pwd1 = cleaned_data.get("new_password1")
        if new_pwd != new_pwd1:

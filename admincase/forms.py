...
from admincase.models import AdminCase, AdminHisResult, AdminDetail, AdminNaturePerson, AdminLegalPerson, \
    AdminLawsuitScheme, AdminEvidence, AdminAskingOutline, AdminCompensate, AdminApplications
...
class AdminCaseForm(forms.ModelForm):
    """行政案件"""
...
class AdminHisResultForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
    ...
    class Meta:
        model = AdminHisResult
        fields = ('stage', 'legal_status', 'court_name', 'judge_date', 'judge_code', 'judge_result', 'judge_manner')


AdminHisResultFormSet = inlineformset_factory(
                    AdminCase,
                    AdminHisResult,
                    form=AdminHisResultForm,
                    fields=('stage', 'legal_status', 'court_name', 'judge_date', 'judge_code', 'judge_result', 'judge_manner'),
                    widgets={
...
class AdminLawyerForm(forms.ModelForm):
    """行政案件分配律师"""
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
...
AdminNaturePersonFormSet = inlineformset_factory(
                    AdminDetail,
                    AdminNaturePerson,
...
AdminLegalPersonFormSet = inlineformset_factory(
                    AdminDetail,
                    AdminLegalPerson,
...
class AdminCaseSchemeForm(forms.ModelForm):
    """行政案件诉讼方案"""
    ...
    class Meta:
        model = AdminLawsuitScheme
        fields = "__all__"

        widgets = {
            'admin_detail': forms.Select(attrs={'class': "form-control"}),
...
# 证据目录
AdminEvidenceFormSet = inlineformset_factory(
                    AdminLawsuitScheme,
                    AdminEvidence,
...
# 询问提纲
AdminAskingOutlineFormSet = inlineformset_factory(
                    AdminLawsuitScheme,
                    AdminAskingOutline,
...
# 赔偿明细
AdminCompensateFormSet = inlineformset_factory(
                    AdminLawsuitScheme,
                    AdminCompensate,
                    fields=('content',),
                    widgets={
...
# 所需申请书
AdminApplicationsFormSet = inlineformset_factory(
                    AdminLawsuitScheme,
                    AdminApplications,
                    fields=('appli_name',),
                    widgets={
